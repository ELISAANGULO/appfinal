...
function getData() {
  ...
  var arranque = Drowback + perfo;
  var declinaciondia = declinacion/365;
  var rango = fin - inicio;
  var diastotales = rango*365;
...
//PARTE DE PRODUCCION BY banished_from;
...
dd = calProud(declinaciondia, crudo, diastotales, equipos_perforacion, pozos, arranque, delta); //// cambiar valores
console.log(dd);
...
const formulario = document.getElementById("visualizar");
